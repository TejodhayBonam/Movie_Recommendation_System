...
Check out the live demo: https://movie-recommendation-system0.herokuapp.com/
...
2. Install all the libraries mentioned in the [requirements.txt](https://github.com/TejodhayBonam/Movie_Recommendation_System/blob/main/requirements.txt) file with the command `pip install -r requirements.txt`.
